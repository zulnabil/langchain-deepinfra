"""Wrapper around DeepInfra's Chat Completions API."""
...
class ChatDeepInfra(BaseChatOpenAI):
    r"""ChatDeepInfra chat model.

    Setup:
        Install ``langchain-deepinfra`` and set environment variable ``DEEPINFRA_API_TOKEN``.
    ...
    Key init args — client params:
        ...
        api_key: Optional[str]
            DeepInfra API key. If not passed in will be read from env var DEEPINFRA_API_TOKEN.
    ...
    Tool calling:
        .. code-block:: python
            ...
            # Only certain models support tool calling, check the deepinfra website to confirm compatibility
    ...
    def lc_secrets(self) -> Dict[str, str]:
        ...
        """
        return {"deepinfra_api_token": "DEEPINFRA_API_TOKEN"}

    @classmethod
    def get_lc_namespace(cls) -> List[str]:
        """Get the namespace of the langchain object."""
        return ["langchain", "chat_models", "deepinfra"]
    ...
    def lc_attributes(self) -> Dict[str, Any]:
        ...
        if self.deepinfra_api_base:
            attributes["deepinfra_api_base"] = self.deepinfra_api_base
    ...
    model_name: str = Field(default="meta-llama/Meta-Llama-3.1-8B-Instruct", alias="model")
    """Model name to use."""
